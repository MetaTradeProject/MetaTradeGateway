...
public final class FakeTradeGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.freesia.metatradegateway.rpc.FakeTradeMessage,
      com.freesia.metatradegateway.rpc.SubmitResult> getSubmitFakeTradeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SubmitFakeTrade",
      requestType = com.freesia.metatradegateway.rpc.FakeTradeMessage.class,
      responseType = com.freesia.metatradegateway.rpc.SubmitResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.freesia.metatradegateway.rpc.FakeTradeMessage,
      com.freesia.metatradegateway.rpc.SubmitResult> getSubmitFakeTradeMethod() {
    io.grpc.MethodDescriptor<com.freesia.metatradegateway.rpc.FakeTradeMessage, com.freesia.metatradegateway.rpc.SubmitResult> getSubmitFakeTradeMethod;
      ...
      synchronized (FakeTradeGrpc.class) {
        if ((getSubmitFakeTradeMethod = FakeTradeGrpc.getSubmitFakeTradeMethod) == null) {
          FakeTradeGrpc.getSubmitFakeTradeMethod = getSubmitFakeTradeMethod =
              io.grpc.MethodDescriptor.<com.freesia.metatradegateway.rpc.FakeTradeMessage, com.freesia.metatradegateway.rpc.SubmitResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SubmitFakeTrade"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.freesia.metatradegateway.rpc.FakeTradeMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.freesia.metatradegateway.rpc.SubmitResult.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void submitFakeTrade(com.freesia.metatradegateway.rpc.FakeTradeMessage request,
        io.grpc.stub.StreamObserver<com.freesia.metatradegateway.rpc.SubmitResult> responseObserver) {
  ...
  public static final class FakeTradeStub
    ...
    /**
     */
    public void submitFakeTrade(com.freesia.metatradegateway.rpc.FakeTradeMessage request,
        io.grpc.stub.StreamObserver<com.freesia.metatradegateway.rpc.SubmitResult> responseObserver) {
  ...
  public static final class FakeTradeBlockingStub
    ...
    /**
     */
    public com.freesia.metatradegateway.rpc.SubmitResult submitFakeTrade(com.freesia.metatradegateway.rpc.FakeTradeMessage request) {
  ...
  public static final class FakeTradeFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.freesia.metatradegateway.rpc.SubmitResult> submitFakeTrade(
        com.freesia.metatradegateway.rpc.FakeTradeMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUBMIT_FAKE_TRADE:
          serviceImpl.submitFakeTrade((com.freesia.metatradegateway.rpc.FakeTradeMessage) request,
              (io.grpc.stub.StreamObserver<com.freesia.metatradegateway.rpc.SubmitResult>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.freesia.metatradegateway.rpc.FakeTradeMessage,
              com.freesia.metatradegateway.rpc.SubmitResult>(
  ...
  private static abstract class FakeTradeBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.freesia.metatradegateway.rpc.FakeTradeProto.getDescriptor();
    }
